...
void show_gravity(imu_msg_t *imu_values){
    ...
    *   the systeme to switch to another thread.
...
int main(void)
{
    ...
    */
    ...
    //to change the priority of the thread invocking the function. The main function in this case
